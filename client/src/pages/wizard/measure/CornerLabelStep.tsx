...
const SHAPE_VARIANTS: Record<string, ShapeVariant> = {
  ...
  L_SHAPE_2: {
    ...
    corners: [
      { label: 'A', description: 'левый средний', cx: 14, cy: 62 },
      { label: 'B', description: 'левый верхний', cx: 14, cy: 12 },
      { label: 'C', description: 'правый верхний', cx: 114, cy: 12 },
      { label: 'D', description: 'правый нижний', cx: 114, cy: 102 },
      { label: 'E', description: 'нижний (ступень)', cx: 54, cy: 102 },
      { label: 'F', description: 'внутренний угол', cx: 54, cy: 62 },
    ],
  },
  ...
  T_SHAPE_1: {
    ...
    corners: [
      { label: 'A', description: 'левый нижний', cx: 22, cy: 93 },
      { label: 'B', description: 'нижний (у выступа)', cx: 78, cy: 93 },
      { label: 'C', description: 'внутренний нижний', cx: 78, cy: 68 },
      { label: 'D', description: 'правый нижний (стебля)', cx: 134, cy: 68 },
      { label: 'E', description: 'правый верхний (стебля)', cx: 134, cy: 32 },
      { label: 'F', description: 'внутренний верхний', cx: 78, cy: 32 },
      { label: 'G', description: 'верхний (у выступа)', cx: 78, cy: 7 },
      { label: 'H', description: 'левый верхний', cx: 22, cy: 7 },
    ],
  },
  ...
  T_SHAPE_2: {
    ...
    corners: [
      { label: 'A', description: 'левый нижний (основания)', cx: 18, cy: 56 },
      { label: 'B', description: 'внутренний левый', cx: 53, cy: 56 },
      { label: 'C', description: 'нижний левый (стебля)', cx: 53, cy: 96 },
      { label: 'D', description: 'нижний правый (стебля)', cx: 103, cy: 96 },
      { label: 'E', description: 'внутренний правый', cx: 103, cy: 56 },
      { label: 'F', description: 'правый нижний (основания)', cx: 138, cy: 56 },
      { label: 'G', description: 'правый верхний', cx: 138, cy: 16 },
      { label: 'H', description: 'левый верхний', cx: 18, cy: 16 },
    ],
  },
  ...
  T_SHAPE_3: {
    ...
    corners: [
      { label: 'A', description: 'левый нижний (стебля)', cx: 14, cy: 74 },
      { label: 'B', description: 'левый верхний (стебля)', cx: 14, cy: 38 },
      { label: 'C', description: 'внутренний верхний', cx: 70, cy: 38 },
      { label: 'D', description: 'верхний (у основания)', cx: 70, cy: 13 },
      { label: 'E', description: 'правый верхний', cx: 126, cy: 13 },
      { label: 'F', description: 'правый нижний', cx: 126, cy: 99 },
      { label: 'G', description: 'нижний (у основания)', cx: 70, cy: 99 },
      { label: 'H', description: 'внутренний нижний', cx: 70, cy: 74 },
    ],
  },
