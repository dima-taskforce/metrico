...
const SHAPE_META: Record<string, ShapeMeta> = {
  ...
  L_SHAPE_2: {
    ...
    corners: { A: [14, 62], B: [14, 12], C: [114, 12], D: [114, 102], E: [54, 102], F: [54, 62] },
  },
  ...
  T_SHAPE_1: {
    ...
    corners: { A: [22, 93], B: [78, 93], C: [78, 68], D: [134, 68], E: [134, 32], F: [78, 32], G: [78, 7], H: [22, 7] },
  },
  // T_SHAPE orientation 2: stem bottom
  T_SHAPE_2: {
    viewBox: '0 0 148 106',
    outline: '18,56 53,56 53,96 103,96 103,56 138,56 138,16 18,16',
    corners: { A: [18, 56], B: [53, 56], C: [53, 96], D: [103, 96], E: [103, 56], F: [138, 56], G: [138, 16], H: [18, 16] },
  },
  // T_SHAPE orientation 3: stem left
  T_SHAPE_3: {
    viewBox: '0 0 148 106',
    outline: '14,74 14,38 70,38 70,13 126,13 126,99 70,99 70,74',
    corners: { A: [14, 74], B: [14, 38], C: [70, 38], D: [70, 13], E: [126, 13], F: [126, 99], G: [70, 99], H: [70, 74] },
  },
